...
(* OASIS_START *)
(* DO NOT EDIT (digest: b39d96d83791d036fce6e203951ecefe) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("make", ["-C"; "lib_test/"]))];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "SÓ«\001Þ\148½êÄ?\150k\132e­n";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
