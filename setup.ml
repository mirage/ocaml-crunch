...
(* OASIS_START *)
(* DO NOT EDIT (digest: 710cf0120f0ebd4daa3edcc1de49b293) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "Compile static files into an OCaml \"ramdisk\" module";
          description = None;
          categories = [];
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "crunch.ml"; })
            ];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\001Ï\143\t6­\143µÊ\133ædÄ\139ÆK";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
